            ...
            <div className="row">
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    ...
                    will be able to take the first free ride.Rider details will
                    be messaged 12 hrs before your ride on your phone
                    number.Once your first free ride is done, your will have to
                    make the payment for your all the rides scheduled for the
                    week or month.Once your first free ride is done, your will
                    have to make the payment for your all the rides scheduled
                    for the week or month.Next ride will be scheduled only after
                    the advance payment.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              ...
              >
                <Accordion.Item className="p-2 shadow">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    ...
                    students. The rate is at 11Rs/km. Please refer to the below
                    table for exact charges.
                    <div
                      className="my-1"
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    ...
                    you go alone or with a co-passenger, you will charged basis
                    the 14Rs/km rate. If you are able to get a co-passenger in
                    your route and time, we will offer a 10% discount for both
                    the passengers on your subscription amount.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              {/* ---------------------------------- */}
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    ...
                    free if informed 2 hours in advance via sending a “cancel my
                    ride” message on whatsapp. This can happen only in 10% of
                    the total rides booked by the customer. For eg. (4 rides are
                    cancellable if 40 trips are booked, 1 ride is cancellable if
                    5 trips are booked). All canceled rides will be added to
                    next month’s subscription plan free of cost. In any case,
                    customers will have to bear the cost for any rides canceled
                    above the prescribed 10% rides.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              {/* ---------------------------------- */}
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    ...
                    available. You need to inform 2 hours in advance in case you
                    want to change your pickup timings. MyPickup reserves the
                    right to accept or reject the reschedule request. In such
                    cases, cancelled rides will be carry-forwarded basis above
                    canellation policy.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  >
                    <p style={{ fontWeight: "bold" }}>
                      {" "}
                      Can I change the location once I have taken subscription?{" "}
                    </p>
                  </Accordion.Header>
                  <Accordion.Body className="p-4 text-start">
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    Mostly yes. But in case if the same driver is not available
                    or there is vehicle breakdown, we will send an alternate
                    driver.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              ...
              >
                <Accordion.Item className="p-2 shadow ">
                  ...
                  <Accordion.Body className="p-4 text-start">
                    In case the driver is late by 10 min of your desired pickup
                    time. You will be refunded for that trip by the end of the
                    day. Delayed trips will not be refunded in case of major
                    traffic jams, rains or water-logging.
                  </Accordion.Body>
                </Accordion.Item>
              </Accordion>
              {/* ---------------------------------- */}
